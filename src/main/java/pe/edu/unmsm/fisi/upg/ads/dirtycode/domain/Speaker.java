...
public class Speaker {
	...
	static final int MIN_YEARS_EXPERIENCE = 10;
	static final int MIN_NUMBER_CERTIFICATIONS = 3;
	static final int MIN_VERSION_IE = 9;
	...
	public Integer register(IRepository repository) throws Exception {
		...
		String emailDomain = getEmailDomain(this.email);
		...
		isStandarApproved = (!domains.contains(emailDomain) && (!(browser.getName() == WebBrowser.BrowserName.InternetExplorer && browser.getMajorVersion() < MIN_VERSION_IE)));
